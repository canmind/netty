...
public class LocalChannelTest {
    ...
    public void localChannelRaceCondition() throws Exception {
        ...
        final EventLoopGroup clientGroup = new DefaultEventLoopGroup(1) {
            @Override
            protected EventLoop newChild(Executor executor, MetricsCollector collector, Object... args)
                    throws Exception {
                return new SingleThreadEventLoop(this, executor, NoMetricsCollector.INSTANCE, true) {
                    @Override
                    protected void run() {
