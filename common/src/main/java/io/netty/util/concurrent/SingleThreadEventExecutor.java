...
public abstract class SingleThreadEventExecutor extends AbstractEventExecutor {
    ...
    private final Runnable AS_RUNNABLE = new Runnable() {
        ...
        public void run() {
            ...
            // TODO: Thread Interrupt on EventExecutor doesn't work anymore.
            // Or maybe it does. Think about it.
            if (interrupted) {
                thread.interrupt();
            }
    ...
    public boolean awaitTermination(long timeout, TimeUnit unit) throws InterruptedException {
        ...
        if (threadLock.tryAcquire(timeout, unit)) {
            // TODO: I think this call is wrong here. If an event loop can be started multiple times.
            threadLock.release();
        }
